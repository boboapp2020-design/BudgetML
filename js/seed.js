...
const SEED = (() => {
  ...
  return {
    meta: {
      ...
      volumeEditors: {
        caneCompany: ['2712'],    // ตันอ้อยไร่บริษัท (แถว 53) → แผนกบริการไร่
        caneCommunity: ['2712'],  // ตันอ้อยไร่ส่งเสริม (แถว 54) → แผนกบริการไร่
        sugarProduce: ['3224'],   // ตันน้ำตาลผลิต (แถว 56) → แผนกหม้อปั่น
        sugarTrading: ['1143'],   // ตันน้ำตาล Trading (แถว 57) → งานการตลาด/ขาย
      },
      pptCategories: (typeof PPT_MAP !== 'undefined') ? PPT_MAP.codeName : {},  // รหัสหมวด PPT → ชื่อ
      // จำนวนเงินหน้าต้นทุนต่อหน่วย ดึง auto จาก GL ตามงบ (ไม่กรอกมือ) — pptEditors ไม่ใช้แล้ว (เว้นว่าง)
      pptEditors: {},
    },
    oversight: OVERSIGHT,
