...
const Supa = (() => {
  ...
  const TABLES = [
    ...
    { name: 'assumption_cells', pk: ['year', 'r', 'c'], assign: 'assumptionCells', optional: true, // ค่าที่แก้ในหน้า Assumption (MTP) — override ราย ปี×cell
      list: db => db.assumptionCells || [],
      toRow: a => ({ year: a.year, r: a.r, c: a.c, v: a.v, updated_at: nz(a.updatedAt), updated_by: nz(a.updatedBy) }),
      fromRow: r => ({ year: r.year, r: r.r, c: r.c, v: r.v, updatedAt: r.updated_at, updatedBy: r.updated_by }),
    },
