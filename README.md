...
หน้า Login แสดง**หน่วยงานทั้ง 17 หน่วยงาน** — คลิกเลือกหน่วยงานเพื่อเข้าใช้งานได้เลย
(ระบบรหัสผ่านรายแผนกจะเปิดใช้ในขั้นถัดไป — โครงสร้างบัญชีผู้ใช้แยกรายแผนกเตรียมไว้แล้ว: username = รหัสหน่วยงาน)

| บทบาท | ทำอะไรได้ |
|---|---|
| Department User (17 หน่วยงาน) | เห็นเฉพาะ GL ของตนเอง, กรอกงบ 12 เดือน + MTP, Reason/Assumption, Submit |
